          ...
          <div className="flex items-start justify-between">
            <div className="flex-1">
              ...
              <div className="flex items-center gap-2 mb-3">
                <Star className={`h-5 w-5 ${restaurant.rating > 0 ? 'text-yellow-400 fill-yellow-400' : 'text-gray-300'}`} />
                <span className="text-gray-700 font-medium">
                  {restaurant.rating > 0 ? restaurant.rating.toFixed(1) : '0.0'} ({restaurant.reviewCount})
                </span>
              </div>
